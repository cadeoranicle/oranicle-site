console.log("[SKU4.54.js] file loaded");

(function initSKU454Renderer(global) {
    "use strict";
                ...
                <div class="sku554-metric-header">
                    <div>
                        <div class="sku554-metric-label">
                            ${escapeHtml(metric.label || metric.metric_name || metric.metric_key || "")}
                        </div>
    ...
    function render({ targetEl, payload, contract }) {
        ...
        targetEl.innerHTML = `
            <div class="sku554-shell">
                        ...
                        <div class="sku554-priority-banner">
                            ...
                            <div class="sku554-priority-content">
                                ...
                                <div class="sku554-priority-text">
                                    ${escapeHtml(beeMetric.label || beeMetric.metric_name || beeMetric.metric_key || "")}
                                </div>
                            </div>
                        </div>
                    `
                ...
                <div class="sku554-lhs-note">
                    <strong>How to read this:</strong>
                    Compare provider position against peer and regional medians. The 🐝 marker highlights the largest benchmark gap.
                </div>
    ...
    function renderBenchmarkChart(metrics) {
        ...
        const labels = metrics.map(metric =>
            metric.label || metric.metric_name || metric.metric_key || ""
        );
